...
const (
	...
	BlobTxBlobGaspriceUpdateFraction   = 1112826    // Controls the maximum rate of change for blob gas price
	BlobTxPointEvaluationPrecompileGas = 50000      // Gas price for the point evaluation precompile.

	BlobTxTargetBlobGasPerBlock = 1 * BlobTxBlobGasPerBlob // Target consumable blob gas for data blobs per block (for 1559-like pricing)
	MaxBlobGasPerBlock          = 2 * BlobTxBlobGasPerBlob // Maximum consumable blob gas for data blobs per block
