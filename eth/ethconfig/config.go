...
func CreateConsensusEngine(stack *node.Node, ethashConfig *ethash.Config, cliqueConfig *params.CliqueConfig, auraConfig *params.AuthorityRoundParams, notify []string, noverify bool, db ethdb.Database) consensus.Engine {
